...
implementing transactions \emph{in-band}, on the 
switch itself.
...
exchange \liron{--------why one? ---------}  with the data plane, tolerating asynchrony and failures of
...
e.g., for load-balancing applications. \liron{I think this is a bit hard to understand}
