...
Then the controller selects any \emph{unused} id and computes the update commands to be executed (Line~\ref{update:compute}). %\liron{I have replaced "claims the first" with "chooses an" following Petr email}
