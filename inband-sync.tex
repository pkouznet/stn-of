...
implement a generic replicated service~\cite{Her91,Lam98} in a consistent and
...
Figure~\ref{fig:CAS-example} can be easily resolved if we put
policy update in our transactional $\execatomic$ construct together
