...
We show that a powerful transactional interface can be implemented \emph{inband}, using 
...
a replicated control-plane service, consistent policy composition, and load-balancing.
\end{abstract}
...
\keywords{Software-Defined Networking, Distributed Control Plane, In-band Mechanisms}
...
protocol. This allows us to efficiently alleviate the problems related to
