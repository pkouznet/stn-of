...
\liron{following Petr's comments (regarding last paragraph), I suggest the following paragraph (instead of the old version which is still in the text before)}
...
\liron{ Also updated the following paragraph:}
